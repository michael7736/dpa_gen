...
from ..database.qdrant_process_safe import ProcessSafeQdrantManager, get_process_safe_qdrant_manager
...
class QdrantManager(ProcessSafeQdrantManager):
    """Qdrant向量数据库管理器 - 继承自进程安全版本"""
